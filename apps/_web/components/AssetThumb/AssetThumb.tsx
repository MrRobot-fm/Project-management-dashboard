...
export const AssetThumb = ({ file, removeButton, canDownload = false }: AssetThumbProps) => {
  const handleDownload = () => {
    if (canDownload) downloadAsset({ name: file.name, path: "path" in file ? file.path : "" });
  };
  ...
  return (
    <div
      ...
      className={cn(
        ...
        canDownload && "cursor-pointer hover:opacity-70 transition-opacity duration-300",
      )}
